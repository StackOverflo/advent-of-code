...
def main():
    ...
    for line in lines:
        ...
        cardNumber = re.findall(r'Card *(\d+):', line)[0]
        ...
        print(f'card {cardNumber} is worth {gamePoints}, winning set {winningSet}')
        pointTotal += gamePoints

    print(f'total points for all cards is {pointTotal}')
